...
function  g_boxPlot2(data, titleStr, xAxisLabels, xAxisLabelStr, yAxisLabelStr, saveImg, imgName, sigInfo)
%% input arguments
%
% example: g_boxPlot2 (data, 'train run PSC results  per session', {'S1', 'S2', 'S3', 'S4', 'S5'}, 'Sessions', '% Signal Change', 0, sigInfo)
%
if nargin < 8
    sigInfo = {};
end
...
hData_g1 = boxplot(...
    ...
    'MedianStyle'    , 'line'          , ...
    'Symbol'    , 'ko'          , ...
    'Positions',1-offset:2:size(data,2) ,...
    'Widths', .5);
